...
export function SIStartPage() {
    ...
    <Background>
            ...
            <div className="w-full flex flex-col items-center ">
                ...
                <section className="relative mt-3 w-screen mx-[calc(50%-50vw)] aspect-[1920/658] min-h-44 max-h-[420px] lg:max-h-[520px]">
                    ...
                    <div className="absolute inset-0 flex items-center">
                        <div className="px-6 md:px-16 max-w-xl">
                            <h1 className="text-white text-2xl md:text-3xl ml-10 font-bold leading-snug drop-shadow-[0_4px_10px_rgba(0,0,0,0.5)]">
                ...
                {/* About us section */}
                <section className="w-full mt-10 max-w-3xl px-6 py-10 text-lg text-center md:text-left">
                    ...
                    <p className="text-(--color-si-start-page-text) text-lg leading-relaxed mb-4">
                    ...
                    <p className="text-(--color-si-start-page-text) text-lg font-bold leading-relaxed">
                ...
                <section className="w-full flex flex-col items-center gap-2 pb-12">
                    <h2 className="text-(--color-si-join-us-text) text-5xl font-bold mt-7 mb-5">Dołącz do nas!</h2>
