...
def upgrade() -> None:
    ...
    op.create_index('ix_organizations_org_owner_id', 'organizations', ['org_owner_id'], unique=False)
    ...
    op.create_index('ix_organization_invites_created_by_id', 'organization_invites', ['created_by_id'], unique=False)
    ...
    op.create_table('projects',
        ...
        sa.ForeignKeyConstraint(['project_owner_id'], ['users.id'], ondelete='RESTRICT'),
        sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('roles',
        ...
        sa.Column('can_write_tickets', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('can_help', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('can_assign_help', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('can_change_status', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('can_make_roles', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('can_change_roles', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('can_assign_people_to_project', sa.Boolean(), server_default='false', nullable=False),
        sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
        sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    ...
    op.create_index('ix_user_projects_role_id', 'user_projects', ['role_id'], unique=False)
    ...
    op.create_index('ix_categories_project_id', 'categories', ['project_id'], unique=False)
    ...
    op.create_table('incidents',
        ...
        sa.ForeignKeyConstraint(['primary_assignee_id'], ['users.id'], ondelete='SET NULL'),
        sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    ...
    op.create_index('ix_incidents_primary_assignee_id', 'incidents', ['primary_assignee_id'], unique=False)
    ...
    op.create_index('ix_comments_incident_id', 'comments', ['incident_id'], unique=False)
    ...
    op.create_index('ix_incident_logs_person_id', 'incident_logs', ['person_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_organization_invites_created_by_id', table_name='organization_invites')
