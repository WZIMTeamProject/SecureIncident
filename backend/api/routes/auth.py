...
async def login_user(data: LoginRequest, db: AsyncSession = Depends(get_db)):
    """Zaloguj u¿ytkownika i zwróæ JWT token."""
...
async def get_me(
    ...
    """Pobierz dane aktualnie zalogowanego u¿ytkownika."""
...
async def logout_user(
    ...
    """Wyloguj u¿ytkownika (stateless — MVP)."""
...
async def request_password_reset(
    ...
    """Poproœ o reset has³a (zawsze 204, nawet jeœli user nie istnieje)."""
...
async def reset_password(
    ...
    """Zresetuj has³o za pomoc¹ tokenu."""
